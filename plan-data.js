...
window.planData = {
  quarters: [
    ...
    { id:'ct', name:'Центральная часть', description:'Территория возле лагеря «Высоковский бор». На сайте проекта указаны участки для ИЖС площадью 6,5–19,5 сотки.', price:'Цена уточняется', bounds:[335,100,270,310] }
  ],
  plots: [
