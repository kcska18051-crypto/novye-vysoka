...
window.planData = {
  quarters: [
    { id:'nk', name:'Николо-Корма', description:'Участки для ИЖС в селе Николо-Корма. На сайте проекта указаны площади 9–20 соток.', price:'от 45 000 ₽/сотка', bounds:[40,100,270,310] },
    { id:'dg', name:'Дегтярицы', description:'Участки для ИЖС рядом с жилыми домами, неподалёку от бора и Волги. На сайте проекта указаны площади 11–25 соток.', price:'от 70 000 ₽/сотка', bounds:[335,100,270,310] },
    { id:'ct', name:'Центральная часть', description:'Территория возле лагеря «Высоковский бор». На сайте проекта указаны участки для ИЖС площадью 6,5–19,5 сотки.', price:'Цена уточняется', bounds:[630,100,230,310] }
  ],
  plots: [
